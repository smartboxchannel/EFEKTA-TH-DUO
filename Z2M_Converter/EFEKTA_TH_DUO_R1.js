...
const definition = {
        ...
        model: 'EFEKTA_TH_DUO',
        vendor: 'EFEKTALAB',
        description: 'EFEKTA_TH_DUO - Smart device with internal and external temperature and humidity sensor. Thermostat and hygrostat. Self-contained, powered by 2 AAA batteries',
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            const clusters = ['genPowerCfg', 'msTemperatureMeasurement', 'msRelativeHumidity'];
